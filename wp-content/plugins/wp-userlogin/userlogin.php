...
function wpul_scripts() {
    wp_enqueue_style('bootstrap','http://maxcdn.bootstrapcdn.com/bootstrap/3.2.0/css/bootstrap.min.css','3.2.0');
    wp_enqueue_script('bootstrap','http://netdna.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.min.js',array('jquery'),'3.2.0',true);
}
function no_scripts(){
    wp_enqueue_style('wpul',plugins_url('style.css',__FILE__),'14.10');
}
$option = get_option('wpul_settings');
