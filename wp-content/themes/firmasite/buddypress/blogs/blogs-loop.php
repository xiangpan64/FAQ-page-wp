...
<?php if ( bp_has_blogs( bp_ajax_querystring( 'blogs' ) ) ) : ?>
	...
	<ul id="blogs-list" class="item-list list-unstyled" role="main">

	<?php while ( bp_blogs() ) : bp_the_blog(); ?>

		<li class="well well-sm clearfix">
			<div class="item-avatar">
				<a href="<?php bp_blog_permalink(); ?>"><?php bp_blog_avatar( 'type=thumb' ); ?></a>
			</div>

			<div class="item">
				<div class="item-title"><a href="<?php bp_blog_permalink(); ?>" class="lead"><?php bp_blog_name(); ?></a></div>
