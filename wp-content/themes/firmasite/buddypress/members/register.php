				...
				<div class="register-section" id="basic-details-section">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-md-9">
                            ...
                            <input type="text" class="form-control" name="signup_username" id="signup_username" value="<?php bp_signup_username_value(); ?>" aria-required="true"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-md-9">
                            ...
                            <input type="text" class="form-control" name="signup_email" id="signup_email" value="<?php bp_signup_email_value(); ?>" aria-required="true"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-md-9">
                            ...
                            <input type="password" class="form-control password-entry" name="signup_password" id="signup_password" value="" aria-required="true"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-md-9">
                            ...
                            <input type="password" class="form-control password-entry-confirm" name="signup_password_confirm" id="signup_password_confirm" value="" aria-required="true"/>
                        </div>
                    </div>
