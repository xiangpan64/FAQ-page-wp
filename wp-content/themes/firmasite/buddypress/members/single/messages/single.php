...
<div id="message-thread" role="main">
	...
	<?php if ( bp_thread_has_messages() ) : ?>
		...
		<p id="message-recipients">
			...
			<a class="btn btn-default btn-xs button confirm" href="<?php bp_the_thread_delete_link(); ?>" title="<?php esc_attr_e( "Delete Message", 'firmasite' ); ?>"><?php _e( 'Delete', 'firmasite' ); ?></a> &nbsp;
		</p>
